...
class KGSweb_Google_Admin {
    ...
    public function enqueue_admin($hook_suffix): void {
        ...
        // Admin JS (already registered in Integration)
        $admin_js = [
            'admin', 'cache', 'calendar', 'documents', 'helpers',
            'menus', 'ticker', 'upload', 'format', 'slides', 'sheets'
        ];
        ...
        <div class="wrap">
                ...
                <form method="post">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="upload_password" value="<?php echo esc_attr($upload_opts['upload_password']); ?>"></td>
                        </tr>
                        <tr>
                            <th>Reset Locked Users</th>
                            <td><button type="submit" name="kgsweb_reset_locked" class="button">Reset Lockouts</button></td>
                        </tr>
                        <tr>
                            <th>Google Groups Allowed</th>
                            <td><input type="text" name="google_groups" value="<?php echo esc_attr(implode(',', $upload_opts['google_groups'])); ?>" size="50"><br><small>Comma-separated email addresses or groups</small></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="wp_upload_root" value="<?php echo esc_attr($upload_opts['wp_upload_root']); ?>" size="50"><br><small>Used only if destination is WordPress</small></td>
                        </tr>
                    </table>

                    <!-- Save Settings -->
                    <p class="submit">
                        <input type="submit" name="kgsweb_save_settings" class="button button-primary" value="Save Settings">
                    </p>
            ...
            <div class="kgsweb-shortcode-help">
                ...
                <ul class="kgsweb-shortcode-list">
                    ...
                    <li><code>[kgsweb_menu type="breakfast"]</code>, <code>[kgsweb_menu type="lunch"]</code> &nbsp; <i>Displays latest image from Drive folder; converts PDF to PNG if needed via helpers</i></li>
